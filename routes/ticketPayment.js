...
router.post("/resend/request", guestCheckoutLimiter, ticketPaymentController.requestTicketResend);
router.post("/resend/confirm", guestCheckoutLimiter, ticketPaymentController.confirmTicketResend);
